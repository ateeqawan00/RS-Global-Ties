...
const SuperAccountSetting = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axiosInstance.put(
        `/admin/updateAdminEmailAndPassword/${user._id}`,
  ...
  return (
    <>
    <Helmet>
        <title>{`Super Account Setting - RSGlobalTies`}</title>
        <meta
          name='description'
          content='Manage Your account. Get insights, ratings, and user reviews for various products.'
        />
      </Helmet><div className='flex items-center justify-center m-auto'>
...
export default SuperAccountSetting
