...
const AddRequirement = () => {
  ...
  console.log("requirement form data: ", formData)

  return (
    <>
      <Helmet>
        <title>{`Add requirement - RSGlobalTies`}</title>
        <meta
          name='description'
        ...
        <div className=' p-4 md:p-20 bg-white shadow-md rounded-md flex flex-col gap-4 w-full '>
          ...
          <div className='mb-2'>
            <label
              ...
              htmlFor='paymentType'
            >
              Which region are you looking for the sellers?
            </label>
            <select
              id='regionsLookingFor'
              className='w-full h-[55px] px-4 py-2 text-sm  border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600 bg-white'
              name='regionsLookingFor'
              value={formData.regionsLookingFor || ""}
              onChange={handleInputChange}
            >
          ...
          <div className='mb-2'>
            <label
              ...
              htmlFor='paymentType'
            >
              Please specify from which regions you don't want sellers to
              contact you.
            </label>
            <select
              id='regionsToAvoid'
