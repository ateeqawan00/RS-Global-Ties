...
export default function CategoriesTabs() {
  ...
  if (filterParam) {
    ...
    filteredProducts = filteredProducts.filter((product) => {
      ...
      return subCategory === filterParamLower
    })
  }
  ...
  // console.log("filtered products category tabs: ", filteredProducts)
    ...
    <Tabs value={activeTab} className='p-4 min-h-screen'>
      ...
      <TabsBody className='flex flex-col'>
        {filteredProducts && filteredProducts.length > 0 ? (
          ...
          <div className='capitalize py-6 text-center'>No products found</div>
        )}
      </TabsBody>
    </Tabs>
  )
